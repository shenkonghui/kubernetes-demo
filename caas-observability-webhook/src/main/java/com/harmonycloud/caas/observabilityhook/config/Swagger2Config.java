...
public class Swagger2Config {
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("admission-webhook").description("k8s admission webhook")
                .termsOfServiceUrl("http://www.harmonycloud.cn/")
                .contact(new Contact("谐云", "", "yulongdeng@harmonycloud.cn")).version("1.0").build();
    }
